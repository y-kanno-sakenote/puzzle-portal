...
def build():
    ...
    large15 = sorted([i for i in items if i["w"] == 15], key=lambda i: i["metrics"]["D"])
    large25 = sorted([i for i in items if i["w"] == 25], key=lambda i: i["metrics"]["D"])
