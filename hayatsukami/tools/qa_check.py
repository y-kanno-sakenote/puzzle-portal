...
def run_js_tests(index_html_path, my_set):
    ...
    broken_cases_js = r"""
    var brokenCases = [
      {label:"形重複", card:{a:["はな","赤"], b:["はな","青"]}},
      {label:"色重複", card:{a:["はな","赤"], b:["ダイヤ","赤"]}},
      {label:"一致2つ", card:{a:["はな","赤"], b:["ダイヤ","青"]}},
      {label:"残り0個(作為的整合)", card:{a:["はな","青"], b:["ダイヤ","黄"]}},
      {label:"未知の形", card:{a:["さんかく","赤"], b:["ダイヤ","青"]}},
      {label:"未知の色", card:{a:["はな","紫"], b:["ダイヤ","青"]}},
      {label:"null札", card:null},
      {label:"要素不足a", card:{a:["はな"], b:["ダイヤ","青"]}},
      {label:"aがnull", card:{a:null, b:["ダイヤ","青"]}},
      {label:"answerフィールド無し(単に配列)", card:["はな","赤"]},
    ];
    """
...
def run_dom_playthrough(index_html_path):
    ...
    const D_TO_SHAPE = {
      "M50 35A15 15 0 1 1 50 65A15 15 0 1 1 50 35Z M50 2A19 19 0 1 1 50 40A19 19 0 1 1 50 2Z M98 50A19 19 0 1 1 60 50A19 19 0 1 1 98 50Z M50 98A19 19 0 1 1 50 60A19 19 0 1 1 50 98Z M2 50A19 19 0 1 1 40 50A19 19 0 1 1 2 50Z": "はな",
      "M50 5L79 50 50 95 21 50Z": "ダイヤ",
      "M5 50L27 13 73 13 95 50 73 87 27 87Z": "ろっかく",
      "M11 11L50 50 11 89Z M89 11L50 50 89 89Z": "リボン",
      "M50 7A43 43 0 1 0 50 93A43 43 0 1 0 50 7Z M50 29A21 21 0 1 0 50 71A21 21 0 1 0 50 29Z": "わ"
    };
    const FILL_TO_COLOR = {
