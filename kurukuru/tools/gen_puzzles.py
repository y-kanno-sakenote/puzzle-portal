...
# 盤サイズと採用するノード数の帯（--survey の実測 2026-09-13 で決めた）
#   n=5 25〜66 / n=6 40〜146 / n=8 71〜251 / n=10 127〜500（一意な木だけ）
#   ノード数は盤サイズにほぼ比例するので段階の境目は盤サイズで引き、
#   同じ盤サイズの中で分岐の多い（＝考えどころの多い）側だけを採る帯にしてある
TIERS = [
    ("入門", 5, 30, 90),
    ("初級", 6, 55, 160),
    ("中級", 8, 110, 280),
